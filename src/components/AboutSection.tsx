...
export default function AboutSection() {
  ...
  return (
    <section id="hakkimizda" ref={triggerRef} className="relative overflow-hidden border-b border-white/5">
      <div ref={sectionRef} className="flex lg:w-[400vw] flex-col lg:flex-row w-full h-auto lg:h-screen items-center">
        {panels.map((panel, idx) => (
          <div
            key={idx}
            className="about-panel w-full lg:w-vw h-auto lg:h-screen flex-shrink-0 flex items-center justify-center p-6 md:p-16 relative overflow-hidden blueprint-grid"
          >
